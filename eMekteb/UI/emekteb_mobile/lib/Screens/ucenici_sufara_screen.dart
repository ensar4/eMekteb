...
class UceniciSufara extends StatefulWidget {
  const UceniciSufara({super.key});

  @override
  State<UceniciSufara> createState() => _UceniciSufaraState();
}

class _UceniciSufaraState extends State<UceniciSufara> {
  ...
  Future<void> fetchData() async {
    ...
    setState(() {
      listaUcenika = data;
      filteredList = listaUcenika?.result.where((ucenik) => ucenik.nazivRazreda == "Sufara").toList() ?? [];
