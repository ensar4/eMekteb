...
class UceniciHatma extends StatefulWidget {
  const UceniciHatma({super.key});

  @override
  State<UceniciHatma> createState() => _UceniciHatmaState();
}

class _UceniciHatmaState extends State<UceniciHatma> {
