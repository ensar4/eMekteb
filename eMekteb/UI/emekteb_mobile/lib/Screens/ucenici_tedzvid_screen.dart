...
class UceniciTedzvid extends StatefulWidget {
  const UceniciTedzvid({super.key});

  @override
  State<UceniciTedzvid> createState() => _UceniciTedzvidState();
}
...
class _UceniciTedzvidState extends State<UceniciTedzvid> {
  ...
  Future<void> fetchData() async {
    ...
    setState(() {
      ...
      filteredList = listaUcenika?.result.where((ucenik) => ucenik.nazivRazreda == "Tedžvid").toList() ?? [];
