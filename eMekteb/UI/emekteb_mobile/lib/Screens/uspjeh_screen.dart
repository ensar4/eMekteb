          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "${_UserProvider.user!.nazivRazreda.toString()} - ocjene",
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        "Uspjeh za ${_UserProvider.user?.nazivRazreda}",
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "${_UserProvider.user?.prisustvo?.toStringAsFixed(0)}%",
                        style: const TextStyle(
                          fontSize: 18.0,
                          fontWeight: FontWeight.bold,
                        ),
